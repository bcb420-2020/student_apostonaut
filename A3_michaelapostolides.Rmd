...
I used GSEA [@GSEA] for non-thresholded analysis. I used the same geneset file which was used in the class homework:\    
...
HDAC4 is also believed to positively regulate SUMOylation of proteins involved in cognitive function [@HDAC4_SUMO]. Since SAHA downregulates HDAC4, this could explain the downregulation of the "SUMOylation, RNA nuclear export" theme in Figure 1.
...
### Figure 1: Themed network diagram of GSEA results. Upregulated (red), Downregulated( blue)\    
