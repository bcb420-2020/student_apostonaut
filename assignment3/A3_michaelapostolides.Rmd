...
#print(nrow(pos.file.sign) ,nrow(wnt.pos.sign))

rho.gtp.ras <- pos.file.sign[grep("RHO|GTP|RAS", pos.file.sign$NAME),]

neg.file.sign <- neg.file[neg.file$NOM.p.val < pval,]
neg.file.sign[grep("DNA", neg.file.sign$NAME),]
```
